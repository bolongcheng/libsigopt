...
def test_fixed_parameter_af_evaluation(setup_data_fixed_params, acquisition_function, optimizer_class):
    domain = setup_data_fixed_params["domain"]
    data = setup_data_fixed_params["data"]
    mtcov = setup_data_fixed_params["mtcov"]
    mpi = setup_data_fixed_params["mpi"]
