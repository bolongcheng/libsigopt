...
def find_interior_point(halfspaces: np.ndarray) -> tuple[np.ndarray | None, float, bool]:
...
def compute_distance_matrix_squared(x: np.ndarray, z: np.ndarray) -> np.ndarray:
